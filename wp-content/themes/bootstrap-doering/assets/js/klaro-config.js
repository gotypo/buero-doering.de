    ...
    */
    translations: {
        ...
        de: {
            ...
            externaliframe: {
                description: 'Einbettung externer Inhalte',
            },
            googletagmanager: {
            ...
            purposes: {
                ...
                video: 'Streamen von Videos',
                externaliframe: 'Einbettung externer Inhalte'
            },
            technicalTracker: {
                description: 'Cookie für das Cookie-Banner selbst.',
            },
            app: {
                disableAll: {
        ...
        en: {
            ...
            consentNotice:{
                description: 'We use cookies to deliver the best possible web experience. Some cookies are necessary for the websiteâ€™s operation, while others can be adjusted by you at any time. You may accept them all or set yout preferences.',
    ...
    apps: [
        ...
        // EXTERNAL IFRAME
        {
            ...
            /*
             ...
             leave the title attribute here unspecified.
             */
            title: 'Externe Embeds',

            /*
             The purpose(s) of this app that will be listed on the consent notice. Do not
             forget to add translations for all purposes you list here.
             */
            purposes: ['externaliframe'],
