...
//                                  'src' => 'images-alt2',
//                                ),
//			'keywords'			=> array( 'slider', 'slider' ),
//		));
//
//		// register a coloured Background block
//		acf_register_block(array(
//			'name'				=> 'colouredbackground',
//			'title'				=> __('Coloured Background'),
//			'description'		=> __('A custom coloured Background block.'),
//			'render_callback'	=> 'my_acf_block_render_callback',
//			'category'			=> 'layout',
//			'icon'				=> array(
//                                  'background' => '#00A7FF',
...
//                                  'src' => 'admin-page',
//                                ),
//            'keywords'			=> array( 'colouredbackground', 'colouredbackground' ),
//		));
//
//		// register a coloured Gallery
//		acf_register_block(array(
//			'name'				=> 'gallery',
//			'title'				=> __('Gallery'),
//			'description'		=> __('A custom block for image gallery.'),
//			'render_callback'	=> 'my_acf_block_render_callback',
//			'category'			=> 'layout',
//			'icon'				=> array(
//                                  'background' => '#00A7FF',
...
//                                  'src' => 'format-gallery',
//                                ),
//            'keywords'			=> array( 'gallery', 'gallery' ),
//		));
//
...
//                                  'src' => 'media-text',
//                                ),
//            'keywords'			=> array( 'latestnews', 'latestnews' ),
//		));
//	}
//}

/*--- INCLUDE MAIN --*/
// include_once( get_stylesheet_directory() . '/main/core.php' );
// include_once( get_stylesheet_directory() . '/main/backend.php' );
// include_once( get_stylesheet_directory() . '/main/theme.php' );
include_once( get_stylesheet_directory() . '/main/meta.php' );
// include_once( get_stylesheet_directory() . '/main/navigation.php' );
// include_once( get_stylesheet_directory() . '/main/content.php' );

/*--- INCLUDE PLUGINS --*/
include_once( get_stylesheet_directory() . '/plugins/fancybox/fancybox.php' );
include_once( get_stylesheet_directory() . '/plugins/swiper/swiper.php' );
//include_once( get_stylesheet_directory() . '/plugins/datatables/datatables.php' );
include_once( get_stylesheet_directory() . '/plugins/acf/acf.php' );
//include_once( get_stylesheet_directory() . '/plugins/leaflet/leaflet.php' );
